          ...
          children: <Widget>[
            ...
            Padding(
                ...
                child: TextFormField(
                  ...
                  //     ? 'phone number should be atleast 11 digits'
                  //     : null,
                  autofocus: false,
                  obscureText: false,
          ...
          child: GestureDetector(
            onTap: () async {
              ...
              try {
                ...
                print("data in forward one method");
                if (newUser != null) {
                  Navigator.push(
                    context,
                    MaterialPageRoute(builder: (context) => LoginScreen()),
            ...
            child: AnimatedContainer(
              ...
              child: Row(mainAxisSize: MainAxisSize.min, children: <Widget>[
                ...
                AnimatedSize(
                  ...
                  child: show ? Text(" Submit") : Container(),
                ),
                AnimatedSize(
                  vsync: this,
